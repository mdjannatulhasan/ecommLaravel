...
<div class="kic-top ">
	...
	<div class="kic ">
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="{{ asset('') }}ecommerce/assets/images/ki.jpg" class="img-responsive" alt="">
			</a>
			<h6>Dal</h6>
		...
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="{{ asset('') }}ecommerce/assets/images/ki1.jpg" class="img-responsive" alt="">
			</a>
			<h6>Snacks</h6>
			<p>Nam libero tempore</p>
		</div>
		<div class="col-md-4 kic-top1">
			<a href="single.html">
				<img src="{{ asset('') }}ecommerce/assets/images/ki2.jpg" class="img-responsive" alt="">
			</a>
			<h6>Spice</h6>
			<p>Nam libero tempore</p>
		</div>
				...
				<div class=" con-w3l agileinf">
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal1" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of24.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal2" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of25.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal3" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of26.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal4" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of27.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								...
								<a href="#" data-toggle="modal" data-target="#myModal5" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of28.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal6" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of29.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal7" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of30.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal8" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of31.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
											<h6><a href="single.html">Rice</a>(500 g)</h6>
								...
								<a href="#" data-toggle="modal" data-target="#myModal9" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of32.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal10" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of33.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal11" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of34.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
							...
							<div class="col-md-3 pro-1">
								<div class="col-m">
									<a href="#" data-toggle="modal" data-target="#myModal12" class="offer-img">
										<img src="{{ asset('') }}ecommerce/assets/images/of35.png" class="img-responsive" alt="">
									</a>
									<div class="mid-1">
										<div class="women">
