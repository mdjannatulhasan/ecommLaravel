...
<div class="banner-top">
 ...
 <table class="table ">
		...
		<th class="t-head">Quantity</th>
		  ...
		  <tr class="cross">
			<td class="ring-in t-data">
				<a href="single.html" class="at-in">
					<img src="{{ asset('') }}ecommerce/assets/images/wi.png" class="img-responsive" alt="">
				</a>
			<div class="sed">
		  ...
		  <tr class="cross1">
		  <td class="t-data ring-in"><a href="single.html" class="at-in"><img src="{{ asset('') }}ecommerce/assets/images/wi1.png" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
		...
		<td class="t-data"><div class="quantity">
		  ...
		  <tr class="cross2">
		  <td class="t-data ring-in"><a href="single.html" class="at-in"><img src="{{ asset('') }}ecommerce/assets/images/wi2.png" class="img-responsive" alt=""></a>
			<div class="sed">
				<h5>Sed ut perspiciatis unde</h5>
			</div>
			<div class="clearfix"> </div>
